...
export default function LocationFieldInput({ locationText }: LocationFieldInputProps) {
    return (
        <TextField className='w-full flex flex-col gap-2' isReadOnly>
            ...
            <Input
                value={locationText}
                className='flex h-12 text-sm text-muted-foreground placeholder:text-[13px] w-full items-center gap-3 rounded-md bg-accent/70 px-4 cursor-not-allowed shadow-none'
            />
